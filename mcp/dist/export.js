 ...
 */
function resolveExportPath(filePath) {
    if (isAbsolute(filePath))
        return filePath;
    if (EXPORT_DIR)
        return join(EXPORT_DIR, filePath);
    return filePath;
}
/**
 ...
 */
export async function exportCanvas(wss, filePath) {
...
async function exportExcalidraw(elements, filePath) {
    const doc = {
        type: "excalidraw",
        version: 2,
        source: "napkin",
 ...
 */
async function exportVisual(wss, elements, filePath, format) {
